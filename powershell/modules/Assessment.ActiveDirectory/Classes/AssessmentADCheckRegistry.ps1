class AssessmentADCheckDefinition {
    [string]$CheckId
    [string]$Name
    [string]$Description
    [string]$Category
...
class AssessmentADCheckRegistry {
    ...
    [void] Register([object]$Definition) {
        ...
        $RegisteredDefinition = [AssessmentADCheckDefinition]::new(
            $CheckId,
