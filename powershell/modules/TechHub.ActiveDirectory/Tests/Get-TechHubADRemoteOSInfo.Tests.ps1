...
Describe 'Get-TechHubADRemoteOSInfo' {

    BeforeAll {
        . "$PSScriptRoot\..\Public\Get-TechHubADRemoteOSInfo.ps1"
    }
    ...
    It 'returns OS information' {
        ...
        $result = @(Get-TechHubADRemoteOSInfo -ComputerName 'WEB01')
    ...
    It 'supports multiple computers' {
        ...
        $result = @(
            Get-TechHubADRemoteOSInfo -ComputerName 'WEB01','WEB02'
        )
