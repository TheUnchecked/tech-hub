...
Describe 'Get-TechHubADServiceAccounts' {

    BeforeAll {
        . "$PSScriptRoot\..\Public\Get-TechHubADServiceAccounts.ps1"
    }
    ...
    It 'returns normalized service accounts' {
        ...
        $result = @(Get-TechHubADServiceAccounts -ComputerName 'WEB01')
    ...
    It 'supports multiple computers' {
        ...
        $result = @(
            Get-TechHubADServiceAccounts -ComputerName 'WEB01','WEB02'
        )
    ...
    It 'is read-only' {
        ...
        {
            Get-TechHubADServiceAccounts -ComputerName 'WEB01'
        } | Should -Not -Throw
    }
