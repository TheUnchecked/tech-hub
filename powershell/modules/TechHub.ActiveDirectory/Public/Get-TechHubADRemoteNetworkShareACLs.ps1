...
function Get-TechHubADRemoteNetworkShareACLs {
    <#
    .SYNOPSIS
    ...
    begin {
        ...
        function Convert-TechHubShareAccessMask {
            param(
                [Parameter(Mandatory)]
                [int]$Mask
            )
                    ...
                    if ($securitySetting) {
                        ...
                        if (
                            ...
                            foreach ($ace in $sdResult.Descriptor.DACL) {
                                ...
                                $right = Convert-TechHubShareAccessMask `
