# ============================================================
# Assessment.ActiveDirectory - Provider Test Harness Diagnostic
...
Write-Host " Assessment.ActiveDirectory - PROVIDER HARNESS DIAGNOSTIC" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    $ProviderPath = Join-Path `
        $ModuleRoot `
        'Providers\ActiveDirectory\AssessmentADProvider.ps1'

    $ConverterPath = Join-Path `
        $ModuleRoot `
        'Private\ConvertTo-AssessmentADProviderObject.ps1'
    ...
    $LoadedModule = Get-Module Assessment.ActiveDirectory
    ...
    Get-Command `
        -Module Assessment.ActiveDirectory |
        Select-Object `
            Name,
            CommandType,
            Source |
